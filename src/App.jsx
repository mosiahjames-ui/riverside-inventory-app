...
function App() {
  ...
  return (
    <div className="app-shell">
      ...
      <header className="topbar"><a className="brand" href="#inventory"><span className="brand-mark"><i /></span><span><b>Riverside</b><strong>Books</strong></span></a><nav><a href="#inventory">Inventory</a><a href="#pre-orders">Pre-orders</a><a href="#about">About</a></nav><button className="refresh" type="button" onClick={loadData}>Refresh data</button></header>
