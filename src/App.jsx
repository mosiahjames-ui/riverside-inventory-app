...
function App() {
  ...
  return (
    <div className="app-shell">
      ...
      <header className="topbar"><a className="brand" href="#inventory"><span className="brand-mark"><i /></span><span><b>Riverside</b><strong>Books</strong></span></a><nav><button className="header-link" type="button" onClick={showInventory}>Inventory</button></nav><button className="refresh" type="button" onClick={loadData}>Refresh data</button></header>
