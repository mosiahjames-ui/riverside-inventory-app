...
function App() {
  ...
  return (
    <div className="app-shell">
      ...
      <section className="about" id="about"><div><p className="eyebrow">About Riverside Books</p><h2>A neighborhood bookstore by the river.</h2><p>Riverside Books is an independent neighborhood bookstore located along the riverfront in Portland, Oregon. We specialize in new books, thoughtful gifts, and hosting friendly literary gatherings for our community.</p></div><address><strong>Our Location & Contact Info</strong><span>428 Riverfront Place, Suite 100<br />Portland, OR 97201</span><a href="tel:+15035550192">(503) 555-0192</a><a href="mailto:hello@riversidebooks.com">hello@riversidebooks.com</a><a className="staff-contact" href="mailto:staff@riversidebooks.com?subject=Question%20for%20the%20Staff">Ask a Staff Member</a></address></section>
      <section className="tokens" id="tokens"><div><p className="eyebrow">Shared brand system</p><h2>Riverside design tokens</h2><p>A cohesive palette shared across the Riverside Books product suite.</p></div><div className="token-list"><span><i className="token-primary" />Forest · #1B3B2B</span><span><i className="token-teal" />Teal · #1E6B70</span><span><i className="token-sky" />Sky · #3A82C4</span></div></section>
      <footer id="settings"><div><span className="brand-mark"><i /></span><b>Riverside Books</b></div><a href="#inventory" onClick={showInventory}>Inventory Management</a><a href="#about">About &amp; Contact</a></footer>
      </main>
    </div>
  )
}
