...
function App() {
  ...
  return (
    <div className="app-shell">
      ...
      <header className="topbar"><a className="brand" href="#inventory"><span className="brand-mark"><i /></span><span><b>Riverside</b><strong>Books</strong></span></a><nav><button className="header-link" type="button" onClick={showInventory}>Inventory</button><a href="#about" className="text-sm text-[#1B3B2B] hover:text-[#3A82C4] font-medium transition-colors cursor-pointer">About & Contact</a></nav><button className="refresh" type="button" onClick={loadData}>Refresh data</button></header>
      ...
      <footer id="settings"><div><span className="brand-mark"><i /></span><b>Riverside Books</b></div><a href="#inventory" onClick={showInventory}>Inventory Management</a></footer>
      </main>
    </div>
  )
}
