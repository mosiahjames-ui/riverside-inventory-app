...
function App() {
  ...
  return (
    <div className="app-shell">
      ...
      <header className="topbar"><a className="brand" href="#inventory"><span className="brand-mark"><i /></span><span><b>Riverside</b><strong>Books</strong></span></a><nav><a href="#inventory">Inventory</a><a href="#pre-orders">Pre-orders</a><a href="#about">About</a><div className="store-apps"><button type="button" aria-expanded={storeAppsOpen} aria-haspopup="true" onClick={() => setStoreAppsOpen((open) => !open)}>Store Apps <span className={storeAppsOpen ? 'chevron up' : 'chevron'}>⌄</span></button>{storeAppsOpen && <div className="store-apps-menu"><a href="https://riverside-readers-app.vercel.app/" target="_blank" rel="noreferrer">Riverside Readers <small>↗</small></a><a href="#inventory" onClick={() => setStoreAppsOpen(false)}>Inventory &amp; Shift Control</a><a href="https://riverside-books-chatbot-khaki.vercel.app/" target="_blank" rel="noreferrer">Support Chatbot <small>↗</small></a><a href="https://riverside-social-app.vercel.app/" target="_blank" rel="noreferrer">Marketing Generator <small>↗</small></a><a href="https://pursuit-core.slack.com/archives/C0BQP69G23X/p1787360716063449" target="_blank" rel="noreferrer">Team Slack <small>↗</small></a></div>}</div></nav><button className="refresh" type="button" onClick={loadData}>Refresh data</button></header>
